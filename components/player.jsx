  ...
  return (
    <div className="text-white h-24 bg-gradient-to-b from-[#161618] to-black grid grid-cols-3 text-xs md:text-base px-2 md:px-0">
      <div className="flex items-center space-x-4">
        <Image className="hidden md:inline w-10 h-10" src={songInfo?.album.images?.[0]?.url} width={250} height={250} alt="info" />
      ...
      <div className="flex items-center justify-evenly" >
        ...
        {isPlaying ? (
          <AiOutlinePauseCircle onClick={handlePlayPause} className="w-8 h-7 button" />
        ) : (
          <AiOutlinePlayCircle onClick={handlePlayPause} className="w-8 h-7 button" />
        )}
